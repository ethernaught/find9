...
WE NEED TO SWITCH RECORDS TO USE THIS FOR AFXR
- THIS CHANGE NEEDS TO BE MADE FOR ANSWERS, ADDITIONAL, AND AUTHORITATIVES WITHIN
MESSAGE_BASE AND QUERY_EVENT
Vec<(String, Box<dyn RecordBase>)>
